  ...
  return (
    <Layout>
      <div className="mx-auto max-w-3xl">
        ...
        {/* Stat tiles */}
        <div className="grid gap-3 sm:grid-cols-3 pb-12 border-b border-amber-100">
          {[
            ...
            <div key={tile.label} className="rounded-2xl border border-amber-100 bg-white p-5 shadow-sm">
        ...
        <div ref={howItWorksRef} className="py-12 space-y-8">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {[
              ...
              <div key={item.step} className="rounded-2xl border border-amber-100 bg-white p-6 shadow-sm">
                <p className="font-display text-4xl font-bold text-amber-200">{item.step}</p>
